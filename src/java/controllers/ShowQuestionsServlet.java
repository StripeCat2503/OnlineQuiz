 ...
 * @author Admin
 */
@WebServlet(name = "ShowQuestionsServlet", urlPatterns = {"/questions"})
public class ShowQuestionsServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            request.setAttribute("questions", listOfQuestions);
            
        }
        finally{
            RequestDispatcher rd = request.getRequestDispatcher(QUESTIONS_PAGE);
